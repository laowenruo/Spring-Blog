...
public class BlogAdminController {
	...
	@PutMapping("/blog/top")
	public Result updateTop(@RequestParam Integer id, @RequestParam Boolean top) {
	...
	public Result updateRecommend(@RequestParam Integer id, @RequestParam Boolean recommend) {
	...
	public Result getBlog(@RequestParam Integer id) {
		cn.isbut.entity.Blog blog = blogService.getBlogById(id);
